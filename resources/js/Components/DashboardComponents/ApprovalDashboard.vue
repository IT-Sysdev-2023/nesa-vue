<template>
    <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-gray-100 p-8 max-w-md w-full">
        <div class="space-y-4">
            ...
            <a-button type="primary" ghost @click="() => router.get(route('nesa.get.pending.for.approval'))"
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-blue-700">Pending For Approval</span>
                </div>
                <a-badge :count="count?.approvalCount"></a-badge>

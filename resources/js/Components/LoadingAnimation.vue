<template>
    ...
    <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img"
        height="56px" width="56px" viewBox="0 0 56 56" class="loader">
        ...
        <g transform="translate(2,2)">
            ...
            <g transform="translate(13.75,9.25)" class="loader__model">
                ...
                <g stroke-linecap="round" stroke="hsl(35,90%,90%)">
                    ...
                    <line y2="21.75" x2="12.5" y1="16.75" x1="12.5" stroke-dasharray="0.25 33.75" stroke-width="1"
                        class="loader__sand-grain-right"></line>
    ...
    <div class="flex justify-center items-center gap-2 mb-10">
        ...
        <div class="flex space-x-1.5">
            <div class="w-1.5 h-1.5 bg-gray-500 rounded-full animate-[bounce_1s_infinite_-0.3s]"></div>
            <div class="w-1.5 h-1.5 bg-gray-500 rounded-full animate-[bounce_1s_infinite_-0.15s]"></div>
            <div class="w-1.5 h-1.5 bg-gray-500 rounded-full animate-[bounce_1s_infinite]"></div>
        </div>
    </div>

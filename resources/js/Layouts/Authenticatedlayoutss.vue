    ...
    <div :class="[
      ...
      <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200">
        <div class="flex items-center space-x-3">
          ...
          <h2 class="text-xl font-bold text-gray-800">VueHub</h2>
        </div>
        <button 
          @click="sidebarOpen = false"
      ...
      <header class="bg-white shadow-sm border-b border-gray-200">
        <div class="flex items-center justify-between h-16 px-6">
          <div class="flex items-center space-x-4">
            ...
            <h1 class="text-2xl font-bold text-gray-900 capitalize">{{ activeItem }}</h1>
          </div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <button class="p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-lg relative">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5-5V9a9 9 0 10-9 0v3l-5 5h5m7.75-.75a3 3 0 01-4.5 0" />
              </svg>
      ...
      <main class="p-6">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-8 text-white mb-8">
            ...
            <p class="text-blue-100">Here's what's happening with your Vue.js dashboard today.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div :class="['text-sm font-medium', stat.color]">
                  {{ stat.change }}
                </div>
              </div>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-sm">
            <div class="p-6 border-b border-gray-200">
              <h3 class="text-lg font-semibold text-gray-900">{{ activeItem }} Dashboard</h3>
            </div>
            <div class="p-6">
              <div class="text-center py-12">
                ...
                <p class="text-gray-600 max-w-md mx-auto">
                  This is your {{ activeItem }} section. The Vue.js sidebar navigation is fully functional and responsive.
                  Click different menu items to see the active state changes.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a :href="route('dashboard')" class="flex items-center space-x-2">
                        <img class="w-10 h-8" src="/images/nesaLogo.png" alt="Nesa Logo">
                        <span class="text-xl font-bold text-gray-900">BNS</span>
                    </a>
                </div>

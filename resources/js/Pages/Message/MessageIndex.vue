            ...
            <main class="flex-grow flex flex-row min-h-0">
                ...
                >
                    ...
                    >
                        ...
                        <p
                            class="text-md font-bold hidden md:block group-hover:block"
                        >
                            Talk To Nesa
                        </p>
                    ...
                    <div
                        class="contacts p-2 flex-1 overflow-y-scroll space-y-2"
                    >
                        <div
                            v-for="item in everyMessage"
                            :key="item.user_id"
                        ...
                        >
                            <div
                                class="w-16 h-16 relative flex justify-center items-center flex-shrink-0 rounded-full"
                                :class="item.count ? 'bg-blue-300' : ''"
                            >
                                <!-- User Photo -->
                                <img
                                    class="shadow-md rounded-full w-14 h-14"
                                    :src="
                                        'http://172.16.161.34:8080/hrms' +
                                        item.photo
                                    "
                                ...
                                <span
                                    v-if="!item.isOnline"
                                    class="absolute bottom-1 right-1 w-4 h-4 bg-gray-400 border-2 border-gray-900 rounded-full"
                                ></span>
                            </div>
                            ...
                            <div class="flex-auto min-w-0 ml-4 mr-6">
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span
                                        class="ml-2 text-xs text-gray-500 whitespace-nowrap"
                                    >
                                        {{ item.latest_at }}
                                    </span>
                                </div>
                    ...
                    >
                        <div class="mb-20">
                            ...
                            >
                                ...
                                <div
                                    class="mx-auto w-32 h-32 relative -mt-16 border-4 rounded-full overflow-hidden"
                                    :class="
                                        isActive[0]
                                            ? 'border-green-400'
                                            : 'border-gray-300'
                            ...
                            <div class="p-4 mx-8 mt-2">
                                <div class="flex items-center">
                                    <div
                                        class="flex-grow border-t border-gray-700"
                                    ></div>
                                    <span
                                        class="mx-3 text-gray-400 font-semibold text-sm uppercase"
                                        >Start Message</span
                                    >
                                    <div
                                        class="flex-grow border-t border-gray-700"
                        ...
                        <div v-for="(item, index) in messages" :key="item.id">
                            ...
                            >
                                <div
                                    class="w-7 h-7 border-none relative flex flex-shrink-0 mr-1"
                                ...
                                >
                                    <div
                                        class="flex items-end group mb-2"
                                        :class="
                                            item.sender_id == page.auth.user.id
                                                ? 'flex-row-reverse'
                                                : ''
                                    ...
                                    >
                                        ...
                                        <!-- Message bubble -->
                                        <div
                                            class="mx-2 max-w-xs lg:max-w-md"
                                            :class="
                                                item.sender_id ==
                                                page.auth.user.id
                                                    ? 'self-end'
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-3.54-4.46a1 1 0 0 1 1.42-1.42
            ...
            1 1 0 0 1 0 2z"
                            ...
                            >
                                <div class="flex flex-row">
                                    <div
                                        class="w-8 h-8 relative flex flex-shrink-0 mr-4 justify-start"
                                    >
                                        <img
                                            class="shadow-md rounded-full w-full h-full object-cover"
                                            :src="
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <span
                                                        class="w-2 h-2 rounded-full bg-gray-300 animate-jump delay-0"
                                                    ></span>
                                                    <span
                                                        class="w-2 h-2 rounded-full bg-gray-300 animate-jump delay-200"
                                                    ></span>
                                                    <span
                                                        class="w-2 h-2 rounded-full bg-gray-300 animate-jump delay-400"
                                                    ></span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="chat-footer flex-none">
                        <div class="ml-12 flex">
                            <div
                                v-if="toReply"
                                class="flex items-center gap-2 ml-12 mt-2 -mb-3.5"
                            >
                                <!-- Text bubble -->
                                <div
                                    class="px-3 py-2 rounded-full bg-gray-800 text-left max-w-md break-words truncate"
                                >
                                    {{ toReply }}
                                </div>

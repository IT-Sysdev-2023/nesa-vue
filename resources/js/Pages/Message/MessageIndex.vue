<template>
    <div class="h-[85vh] w-[1000px] flex antialiased text-gray-200 bg-gray-900 overflow-hidden">
            ...
            <main class="flex-grow flex flex-row min-h-0">
                <section
                    ...
                    <div class="active-users flex flex-row p-2 overflow-auto w-0 min-w-full">
                        ...
                        <div class="text-sm text-center mr-4" v-for="item in messageUsers">
                            ...
                            <div class="flex flex-row justify-start" v-if="item.recipient_id == page.auth.user.id">
                                ...
                                <div class="messages text-sm text-gray-700 grid grid-flow-row gap-2">
                                    <div class="flex items-center group mb-2">
                                        <p class="px-6 py-3 rounded-b-[2rem] rounded-r-[2rem]  max-w-xs lg:max-w-md text-gray-200"
                                            :class="item.attachment ? '' : 'bg-gray-800'">

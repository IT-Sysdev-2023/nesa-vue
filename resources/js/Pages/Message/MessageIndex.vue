            ...
            <main class="flex-grow flex flex-row min-h-0">
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="text-sm text-center mr-4"
                            v-for="item in messageUsers"
                        >
                            <div
                                class="p-1 border-4 border-blue-600 rounded-full"
                            >
                                <div
                                    class="w-16 h-16 relative flex flex-shrink-0"
                                >
                ...
                >
                    ...
                    <div class="chat-body p-4 flex-1 overflow-y-scroll">
                        <div v-for="item in messages">
                            <div class="flex flex-row justify-start" v-if="item.recipient_id == page.auth.user.id">
                                <div
                                    class="w-8 h-8 relative flex flex-shrink-0 mr-4 " v-if="item.attachment == null"
                                >
                                    <img 
                                        class="shadow-md rounded-full w-full h-full object-cover"
                                        src="https://randomuser.me/api/portraits/women/33.jpg"
                                ...
                                >
                                    <div class="flex items-center group">
                                        <p
                                            class="px-6 py-3 rounded-t-full rounded-r-full  max-w-xs lg:max-w-md text-gray-200" :class="item.attachment ? '': 'bg-gray-800'"
                                        >
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"
                            ...
                            <div class="flex flex-row justify-end" v-if="item.sender_id == page.auth.user.id">
                        
                                <div
                                    class="messages text-sm text-white grid grid-flow-row gap-2 mb-2"
                                >
                                    <div
                                        class="flex items-center flex-row-reverse group"
                                    >
                                        <p
                                            class="px-6 py-3 rounded-t-full rounded-l-full   max-w-xs lg:max-w-md" :class="item.attachment ? '': 'bg-blue-700'"
                                        >
                                            {{ item.attachment ? '': item.message }}
                                        </p>
                                        <button
	...
	C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"
                            ...
                            <div class="flex flex-row justify-end">
                                ...
                                >
                                    <div
                                        class="flex items-center flex-row-reverse group" v-if="item.attachment != null && item.sender_id == page.auth.user.id"
                                    >
                                        <a
	...
	C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"
                            ...
                            <div class="flex flex-row justify-start">
                                ...
                                >
                                    ...
                                    <div
                                        class="flex items-center group" v-if="item.attachment != null && item.recipient_id == page.auth.user.id"
                                    >
                                        <a
                                            class="block w-64 h-64 relative flex flex-shrink-0 max-w-xs lg:max-w-md"
                                            href="#"
	...
	C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"
                ...
                <section>
                    <img src="/images/emptymessage.svg" alt="" />
                </section>
            </main>
        </div>
    </div>

<template>
    <div class="h-screen w-[100%] flex antialiased text-gray-200 bg-gray-900 overflow-hidden">
        <div class="flex-1 flex flex-col">
            ...
            1 1 0 0 1 0 2z" />
                ...
                <div class="flex flex-col flex-auto border-l border-gray-800" v-else-if="addChat">
                   <AddChat>
